      ...
      <div className=' '>
        ...
        <div className='my-10 flex flex-col md:flex-row gap-12'>
          {/* image at left side */}
            ...
            <img src={assets.about_image} className='w-full md:max-w-[360px]' alt="" />
          ...
          <div className='flex flex-col justify-center gap-6 md:w-2/4 text-sm text-gray-600'>
            ...
            <p>
              ...
              managing ongoing care, MediSync is here to support you every
              step of the way.
            </p>
            <b className='text-gray-800'>Our Vision</b>
            <p>
              Our vision at MediSync is to create a seamless healthcare
